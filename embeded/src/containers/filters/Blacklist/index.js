    ...
    render() {
        ...
        return (
            <Tooltip title={tooltipTitle}>
                <MenuButtons title="blacklist" additionalStyles={{marginTop: '20px', width: '150px'}}/>
            </Tooltip>
        )
    }
}
...
export default withStyles(styles)(connect(mapStateToProps, mapDispatchToProps)(Blacklist))